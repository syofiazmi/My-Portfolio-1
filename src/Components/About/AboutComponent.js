            ...
            <div className='about-box flex box'>
                ...
                <div className='about-detail flex'>
                    ...
                    <div className='about-desc'>
                        <p>Hi, my name is Syofi. Currently I am active as a teacher and as a Front-end Developer. I have attended several web development courses and bootcamps to gain more experience in the world of web developments.</p>
                    </div>
                </div>
            </div>
        </section>
